...
const CONFIG = {
  ...
  events: [
    ...
    { day: "Day 03", date: "Sep 9",  title: "Sports & Fun",    desc: "Competitions, games, and community bonding." },
    { day: "Day 04", date: "Sep 10", title: "Maha Aarti",      desc: "The grand aarti ceremony at midnight." },
  ...
  merch: {
    ...
    items: [
      { name: "Festival T-Shirt",  price: "₹299", tag: "Bestseller" },
      { name: "Aarti Thali Set",   price: "₹149", tag: "Limited"    },
      { name: "Prasad Box",        price: "₹99",  tag: ""           },
      { name: "Photo Print",       price: "₹199", tag: "New"        },
    ]
  },
  ...
  sponsors: {
    ...
    items: [
      ...
      { name: "Sponsor Two",   tier: "Gold"   },
      { name: "Sponsor Three", tier: "Silver" },
      { name: "Sponsor Four",  tier: "Silver" },
      { name: "Sponsor Five",  tier: "Bronze" },
      { name: "Sponsor Six",   tier: "Bronze" },
    ]
  },
